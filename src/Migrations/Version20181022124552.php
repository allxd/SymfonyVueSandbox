 ...
 */
final class Version20181022124552 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book DROP authorid, CHANGE id id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', CHANGE name name VARCHAR(255) NOT NULL');
    }
